...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key,Value> {
    ...
    public Value put(Key key, Value val)
    {
        ...
        {
           if(alreadyThere.val!=null&&alreadyThere.val.equals(this.sentinal)) //already there but moved to disk- need to delete it from disk, remove entry from BTree, replace it with the new doc, and return null
            {
                try {
                    this.pm.delete(key);
                } catch (IOException e) {
